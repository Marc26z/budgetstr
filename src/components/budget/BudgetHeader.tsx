import { Heart, KeyRound, PiggyBank, Tag, Users } from 'lucide-react';
...
export function BudgetHeader({ onManageContacts, onManagePartners, onManagePiggyBank, onManageCategories }: BudgetHeaderProps) {
  return (
